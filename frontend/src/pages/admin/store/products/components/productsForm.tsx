...
const ProductForm: React.FC<Props> = ({ type = "create", onClose, current }) => {
    ...
    const createMutation = useMutation({
        ...
        onSuccess: () => {
            queryClient.removeQueries({ queryKey: ["productss"] });
    ...
    return (
        <React.Fragment>
            <div className="mx-auto w-full px-4 pb-8">
                <div>
                    <h2 className="mt-6 text-xl font-semibold tracking-tight">{type == "create" ? "Create" : "Update"} products</h2>
                </div>
                <div className="mt-8">
